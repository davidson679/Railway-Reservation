...
public class Reservation {
    ...
    //System.out.print("Please enter aword");
    int pno[]=new int[275];
    ...
    private void doHeading() throws Exception{
        System.out.println("╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬");
        System.out.println("ôôôôôôôôôôôôôôôôôô Railway Reservation ôôôôôôôôôôôôôôôôôô");
        System.out.println("╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬");
    }
    private void doBook() throws Exception{
        System.out.println("Please Enter The Ticket Class");
        ...
        if(ticketAvailable==1){
            ...
            if (c==1){
                max1 -= t;
                System.out.println("Pay Rs."+t*1800);
            }
            if (c==2){
                max2 -= t;
                System.out.println("Pay Rs."+t*1500);
            }
            if (c==3){
                max3 -= t;
                System.out.println("Pay Rs."+t*1200);
            }
        }
    }
    ...
    private void doSearch () throws Exception{
        int passengerFound=0;
        System.out.println("Enter Passenger No. to search");
        int p=Integer.parseInt(br.readLine());
        for (int i=0; i<pcount; i++){
            if (pno[i]==p){
